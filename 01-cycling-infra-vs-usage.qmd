...
#| warning: false
#| paged-print: false
#| fig-cap: "Relationship between cycling mode share and different types of cycling infrastructure, colored by European region."
...
The analysis reveals varying degrees of association between infrastructure types and cycling levels. Notably, narrow segregated tracks show the strongest correlation ($R^2 =$ `r r2_vals["Segregated (narrow)"]`), significantly higher than total infrastructure ($R^2 =$ `r r2_vals["Total"]`). Off-road paths ($R^2 =$ `r r2_vals["Off-road paths"]`) and painted lanes ($R^2 =$ `r r2_vals["Painted lanes"]`) show weaker associations.
